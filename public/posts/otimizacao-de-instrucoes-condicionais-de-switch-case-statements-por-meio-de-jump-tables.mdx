...
O Intervalo Contíguo de Casos: se os valores dos <High>casos são contíguos ou próximos</High>, é mais eficiente usar uma jump table.

O Número de Casos: se o número de casos é suficiente para justificar a tabela, normalmente <High>5 ou mais casos contíguos</High>.
