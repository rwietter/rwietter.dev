...
- **Intervalo Contíguo de Casos**: se os valores dos **casos são contíguos ou próximos**, é mais eficiente usar uma jump table.

- **Número de Casos**: se o número de casos é suficiente para justificar a tabela, normalmente **5 ou mais casos contíguos**.
