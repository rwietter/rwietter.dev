---
title: Is Favoring Duplication Over Abstraction Really the Best Approach?
...
DRY emerged to address the "Evils of Duplication." [^1] <High color="red">If you have duplicated code, you need to remember where you duplicated it. It’s not a matter of if you’ll forget, but when—and the surprise will not be a pleasant one.</High>
...
<High color="yellow">This leads us to the Rule of Three…</High>
