---
title: Um paralelo entre Programação Declarativa e Programação Imperativa
...
slug: um-paralelo-entre-programacao-declarativa-e-programacao-imperativa
...
![bubble sort](https://substackcdn.com/image/fetch/w_1272,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0a640f32-3aa6-4420-a048-16e4174e1a81_1348x1350.png)
...
![fatorial](https://substackcdn.com/image/fetch/w_1272,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff5c2b102-a99c-45d4-a8ee-71d106821de5_487x157.png)
...
Conforme R. Kowalski em Communications of the ACM, Volume 22, Issue 7, July 1979, <TextHighlight>um algoritmo é composto pela lógica e pelo fluxo de controle. Na programação declarativa, a linguagem tende a abstrair a fluxo de controle e deixar para o programador desenvolver a lógica</TextHighlight>. Formalmente, podemos definir:
...
&\mathcal{A} = \mathcal{L} \times \mathcal{C}
\end{aligned}
$$

_Lloyd, JW._ no artigo [_Practical advantages of declarative programming_](https://www.cse.chalmers.se/~oloft/Papers/wm96.pdf), explica que <TextHighlight>a programação declarativa pode ser entendida como “**Forte**” e "**Fraca**"</TextHighlight>. Isto é, <TextHighlight color="blue">no sentido “Forte”, o programador só fornece a lógica do que precisa</TextHighlight>. <TextHighlight color="red">No sentido “Fraco”, o programador precisa fornecer a lógica e estender o fluxo de controle para computar o resultado esperado</TextHighlight>.
...
![pilares da programação declarativa](https://i.imgur.com/aJz3ZYr.png)
...
Se você chegou até aqui, espero que tenha tido uma ótima leitura e que esse conteúdo possa ter lhe ajudado de alguma forma. Obrigado por ler! Qualquer dúvida, agregação ou correção, [envie-me uma dm no twitter ](https://twitter.com/rwietter).
