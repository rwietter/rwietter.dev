...
Conforme R. Kowalski em Communications of the ACM, Volume 22, Issue 7, July 1979, <High>um algoritmo é composto pela lógica e pelo fluxo de controle. Na programação declarativa, a linguagem tende a abstrair a fluxo de controle e deixar para o programador desenvolver a lógica</High>. Formalmente, podemos definir:
...
_Lloyd, JW._ no artigo [_Practical advantages of declarative programming_](https://www.cse.chalmers.se/~oloft/Papers/wm96.pdf), explica que <High>a programação declarativa pode ser entendida como “**Forte**” e "**Fraca**"</High>. Isto é, <High color="blue">no sentido “Forte”, o programador só fornece a lógica do que precisa</High>. <High color="red">No sentido “Fraco”, o programador precisa fornecer a lógica e estender o fluxo de controle para computar o resultado esperado</High>.
