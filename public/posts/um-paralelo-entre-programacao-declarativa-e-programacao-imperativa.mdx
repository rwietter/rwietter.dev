...
Conforme R. Kowalski em Communications of the ACM, Volume 22, Issue 7, July 1979, _um algoritmo é composto pela lógica e pelo fluxo de controle. Na programação declarativa, a linguagem tende a abstrair a fluxo de controle e deixar para o programador desenvolver a lógica_.
