...
async function getData({ slug }: { slug: string }) {
  try {
    ...
    console.error(`${process.cwd()}/public/atoms/${slug}.mdx`, error)
...
export async function generateMetadata({
  params,
}: PagePropTypes): Promise<Metadata | null> {
  ...
  const seo = makeSeo({
    ...
    keywords: `${frontmatter?.keywords} atoms, blog, rwietter, web development, programming, tech`,
